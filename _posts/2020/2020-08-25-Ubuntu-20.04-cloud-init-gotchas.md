...
excerpt: "Recently while working on my latest Packer Templates I ran into an issue with Ubuntu 20.04. The issue was related to cloud-init not being able to grow..."
---
...
- [Generating/Executing Terraform Plans Using Ansible](/generatingexecuting-terraform-plans-using-ansible/)
- [Python - vSphere Host Networking Info](/python-vsphere-host-networking-info/)
