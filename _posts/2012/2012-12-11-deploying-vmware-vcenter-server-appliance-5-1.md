...
excerpt: "In this guide we will be deploying the VMware vCenter Server Appliance. You can get this from the downloads at vmware.com. I will also be deploying..."
---
...
![Screenshot - Step 1](../../assets/13-54-05.png)

Choose where to save the virtual appliance and provide a different name
if you want to.

![Screenshot - Step 2](../../assets/13-54-56.png)

![Screenshot - Step 3](../../assets/13-55-13.png)
...
![Screenshot - Step 4](../../assets/13-57-25.png)

![Screenshot - Step 5](../../assets/13-58-40.png)

![Screenshot - Step 6](../../assets/13-58-47.png)
...
![Screenshot - Step 7](../../assets/13-59-37.png)

Now open the link using your favorite browser and login using
root/vmware (username/password).

![Screenshot - Step 8](../../assets/14-00-37.png)

Now continue the setup process following the screenshots below.

![Screenshot - Step 9](../../assets/14-04-37.png)

Select Configure with default settings unless you know exactly what you
are doing here. :)

![Screenshot - Step 10](../../assets/14-05-23.png)

![Screenshot - Step 11](../../assets/14-06-48.png)

Click start....

![Screenshot - Step 12](../../assets/14-06-57.png)

![Screenshot - Step 13](../../assets/14-07-30.png)

![Screenshot - Step 14](../../assets/14-11-00.png)

![Screenshot - Step 15](../../assets/14-12-30.png)

Now the initial setup is completed you will be taken to the summary page
as below.

![Screenshot - Step 16](../../assets/14-13-07.png)
...
![Screenshot - Step 17](../../assets/14-15-51.png)
...
![Screenshot - Step 18](../../assets/11-10-16.png)
...
![Screenshot - Step 19](../../assets/11-21-21.png)
...
![Screenshot - Step 20](../../assets/14-50-08.png)
...
![Screenshot - Step 21](../../assets/14-50-53.png)

![Screenshot - Step 22](../../assets/14-52-16.png)

![Screenshot - Step 23](../../assets/14-52-32.png)
...
![Screenshot - Step 24](../../assets/12-48-23.png)
...
![Screenshot - Step 25](../../assets/12-44-19.png)
...
![Screenshot - Step 26](../../assets/14-00-45.png)

Now click Test Connection.

![Screenshot - Step 27](../../assets/14-01-08.png)
...
![Screenshot - Step 28](../../assets/14-16-18.png)
...
![Screenshot - Step 29](../../assets/14-17-42.png)
...
![Screenshot - Step 30](../../assets/14-18-20.png)

Hit OK and you will now have added this user to the permissions.

![Screenshot - Step 31](../../assets/14-18-44.png)
...
![Screenshot - Step 32](../../assets/14-22-26.png)

And our login is successful. Great Job!

![Screenshot - Step 33](../../assets/14-22-49.png)
