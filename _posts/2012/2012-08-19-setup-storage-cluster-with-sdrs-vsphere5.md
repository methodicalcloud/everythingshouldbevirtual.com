...
excerpt: "This is just a quick walk-through of setting up a new storage cluster within vSphere5. When using a storage cluster it makes the management of vm..."
---
...
![New Datastore Cluster_2012-08-19_17-22-01](../../assets/New-Datastore-Cluster_2012-08-19_17-22-01-300x225.png )

Select default which is manual mode. Once you get use to how it works
then you can enable fully automated.

![New Datastore Cluster_2012-08-19_17-23-40](../../assets/New-Datastore-Cluster_2012-08-19_17-23-40-300x227.png )

Keep defaults. Enables SIOC (Storage IO Control), 15ms latency and 80%
storage utilization.

![New Datastore Cluster_2012-08-19_17-24-39](../../assets/New-Datastore-Cluster_2012-08-19_17-24-39-300x225.png )

Select Host and clusters you want to use for the new storage cluster.

![vSphere Client_2012-08-19_17-25-01](../../assets/vSphere-Client_2012-08-19_17-25-01-300x226.png )

Select newly created or existing datastores to add to the storage
cluster.

![New Datastore Cluster_2012-08-19_17-25-52](../../assets/New-Datastore-Cluster_2012-08-19_17-25-52-300x194.png )

View summary and click finish if everything looks good.

![New Datastore Cluster_2012-08-19_17-26-42](../../assets/New-Datastore-Cluster_2012-08-19_17-26-42-300x194.png )

Summary details of the newly created storage cluster.

![vSphere Client_2012-08-19_17-18-55](../../assets/vSphere-Client_2012-08-19_17-18-55-300x121.png )
...
![09-50-16](../../assets/09-50-16-300x132.png )

![09-54-17](../../assets/09-54-17-300x117.png )

![10-01-02](../../assets/10-01-02-300x218.png )
